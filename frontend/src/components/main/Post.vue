...
<template>
  <div class="flex gap-4 max-lg:flex-col-reverse relative">
    <div class="flex flex-col gap-4 w-full">
      <Input v-model="proxyed.title" class="max-sm:hidden w-full h-max p-2 border text-2xl!" placeholder="Title" />
    ...
    <div class="flex flex-col gap-4 lg:w-lg lg:sticky lg:top-0 lg:self-start">
      ...
      <Input v-model="proxyed.title" class="sm:hidden w-full h-max p-2 border text-2xl!" placeholder="Title" />
